...
void ATestTagActor::Test01_NativeTagExists()
{
	...
	bool bValid = SandboxTags::TAG_Sandbox_Role_Tank.IsValid();
...
void ATestTagActor::Test02_NativeTagCompareCheap()
{
	...
	FGameplayTag A = SandboxTags::TAG_Sandbox_Role_Tank;
	FGameplayTag B = SandboxTags::TAG_Sandbox_Role_Tank;
	FGameplayTag C = SandboxTags::TAG_Sandbox_Role_Healer;
	bool bSame = (A == B);
	bool bDiff = (A != C);
...
void ATestTagActor::Test05_TagHierarchy_ParentChildMatch()
{
	...
	bool bMatches = SandboxTags::TAG_Sandbox_Role_Tank.MatchesTag(ParentTag);
...
void ATestTagActor::Test07_TagContainer_HasTag()
{
	...
	Container.AddTag(SandboxTags::TAG_Sandbox_Role_DPS);
	Container.AddTag(SandboxTags::TAG_Sandbox_State_Alive);

	bool bHasDPS = Container.HasTag(SandboxTags::TAG_Sandbox_Role_DPS);
	bool bNoDead = !Container.HasTag(SandboxTags::TAG_Sandbox_State_Dead);
	bool bHasAlive = Container.HasTag(SandboxTags::TAG_Sandbox_State_Alive);
